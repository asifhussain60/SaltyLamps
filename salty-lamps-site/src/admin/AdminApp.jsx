...
// Warns before a tab close/refresh discards unsaved edits. Deliberately does not
// intercept in-app navigation (AdminLink clicks) — only the browser-level exit paths
// a confirm dialog can't otherwise prevent.
